...
export const TEAM_NAMES_BY_YEAR: Record<number, Record<number, string>> = {
  ...
  2017: { 1: "Team Critzer", 2: "The Legend", 3: "I'm Better at Scratch Offs", 4: "Bower Rangers", 5: "Team All-Madden", 6: "I've Fallen And I Can't Get Up!", 7: "A-B-CeeDee", 8: "Password Is Taco", 9: "Wait'll Ya See Mike Vick", 10: "Magic Skol Bus" },
  2016: { 1: "Team Critzer", 2: "The Legend", 3: "I'm Better at Scratch Offs", 4: "Bower Rangers", 5: "Team All-Madden", 6: "I've Fallen And I Can't Get Up!", 7: "A-B-CeeDee", 8: "Password Is Taco", 9: "Wait'll Ya See Mike Vick", 10: "Magic Skol Bus" },
